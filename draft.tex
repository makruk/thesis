...
\subsection{考察・結果}
一回目の実験結果は表\ref{tab:test1}に，二回目の実験結果は表\ref{tab:test2}に示す．意味の誤りの括弧内は実験1，2双方で誤った記述

一回目の実験と二回目の実験を比較すると，全体的に二回目の実験の作業時間が短い．これは同一のシナリオを利用したことが原因とみられる．

\begin{table}[htb]
  \begin{tabular}{|c|c||r|r|r|r|} \hline
    被験者 & ツールの使用 & 作業時間(秒) & 形式の誤り & 文法の誤り & 意味の誤り(実験1,2共通) \\ \hline \hline
    熟練A    &○&2860&　なし & なし & なし (0) \\ \hline
...
\begin{table}[htb]
  \begin{tabular}{|c|c||r|r|r|r|} \hline
    ...
    熟練B    &○&1457& あり & なし & なし (27) \\  \hline
    初学者C  &×&2597& なし & なし & なし (-) \\  \hline
    初学者D  &○&1972& あり & なし & なし (27) \\  \hline
  \end{tabular}
  \label{tab:test2}
  \caption{二回目の実験}
\end{table}
