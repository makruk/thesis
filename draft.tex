...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=12cm]{img/scenarioFirst.pdf}
  \end{center}
  \caption{シナリオ開始前の画面}
...
\section{評価}
本ツールを使用した場合のシナリオ作成への影響を測るため，被験者に本ツールを使用してシナリオを作成してもらい，評価を行う．

\subsection{実験の内容}
最初に，被験者に対して対象手法，本ツールについて説明を行う．続いて，被験者にはチュートリアルとして小規模なシステムに関するシナリオを書いてもらう．その後，被験者にシステムの画面のスクリーンショットから作成した資料を見せ，シナリオを作成してもらう．
...
\subsection{考察・結果}
一回目の実験結果は表\ref{tb:test1}に，二回目の実験結果は表\ref{tb:test2}に示す．意味の誤りの括弧内は，実験1，2双方にみられた同一の誤りである．これはシナリオの解釈に失敗したもので，ツールの効果には関係が無いといえる．

実験結果に対して，形式の誤り，文法の誤り，意味の誤り，シナリオ作成時間の4点に関して考察する．

\begin{table}[htb]
  \begin{tabular}{|c|c||c|c|c|c|} \hline
    被験者 & ツールの使用 & 作業時間(秒) & 形式の誤り & 文法の誤り & 意味の誤り (共通) \\ \hline \hline
    熟練A    &○&2860&　なし & なし & 0 (0) \\ \hline
    熟練B    &×&2114& なし & なし &　5 (27) \\ \hline
...
\begin{table}[htb]
  \begin{tabular}{|c|c||c|c|c|c|} \hline
    被験者 & ツールの使用 & 作業時間(秒) & 形式の誤り & 文法の誤り & 意味の誤り (共通) \\ \hline \hline
    熟練A    &×&1696& なし & なし & 1 (0) \\ \hline
    熟練B    &○&1457& あり & なし & 0 (27) \\  \hline
...
初学者Cの誤りは，本ツールの操作ミスにより，評価不能な程多くなった．これに関して，初学者Cから「ある点で間違えたことが後にわかった時など、どこまでもどればいいか視覚的にわからない」という意見を受けた．作成中のシナリオを視覚的に提示することで，操作ミスによる誤りを低減できると考えられる．

また，初学者Dの誤りは，画面インスタンス名の記入忘れが一点，画面インスタンスの記入忘れが一点，入力保存に関わる項目の配置の間違いが一点であった．これに関して，本ツールでは画面インスタンス名は空欄で無いかチェックされる．また，画面インスタンスの配置は自動で行われるため，誤ることはない．従って，初学者Dに対して誤り防止に効果を発揮した．

\subsubsection{シナリオ作成時間}
一回目の実験と二回目の実験を比較すると，すべての被験者で二回目の実験の作業時間が短い．これは同一のシナリオを利用したことが原因とみられ，シナリオを理解する分の時間が多くかかったと推測される．

これを踏まえて，初学者Cと初学者Dを比較すると，実験1，2共にツールを使用した被験者が早くシナリオを作成している．
...
ツールによって入力量を削減し，手法の利用コストを低減した．また，手法独自の記法をツールによって補完し，誤字のリスクを低減した．
